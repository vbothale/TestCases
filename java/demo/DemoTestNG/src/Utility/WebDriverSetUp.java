...
public class WebDriverSetUp {
	...
	public static WebDriver getDriver(String browserType) throws IOException
	{
		...
		case "InternetExplorer":
			File file = new File("C:\\Workspace_QA\\TestCases\\java\\demo\\DemoTestNG\\src\\drivers\\IEDriverServer.exe");
		...
		case "Chrome":
			File fileChrome = new File("C:\\Workspace_QA\\TestCases\\java\\demo\\DemoTestNG\\src\\drivers\\chromedriver.exe");
